...
class OpenMeteoClient
  def self.forecast(lat:, lon:)
    ...
    uri.query = URI.encode_www_form(
      ...
      daily: "temperature_2m_max,temperature_2m_min", timezone: AppConfig.openmeteo_timezone
    )
    ...
    { current_c: j.dig("current_weather", "temperature"), high_c: daily.first&.[](:max_c), low_c: daily.first&.[](:min_c), daily: }
  end
end
